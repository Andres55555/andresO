...
<?php require 'includes/Registro_usuarios1.php'; ?>
...
<div class="row">
 ...
 <div class="card">
   ...
   <form action="Registro_useradmin.php" method="post">
...
<br/>
User: <input  require class="form-control" type="hidden"  name="rol" value="1" readonly >
<br/>
<div class="card-header">
   <div class="card-body">
