...
<input require class="form-control" type="hidden" value="user admin" readonly name="ciudad" >
<input require class="form-control" type="hidden" value="user admin" readonly name="direccion" >
<input  require class="form-control" type="hidden"  name="rol" value="1" readonly >
<br/>
